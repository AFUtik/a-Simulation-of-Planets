...
class Planet:
    ...
    def draw(self, win: pygame.Surface):
        ...
        if len(self.orbit) > 2 and self.LINES: 
            updated_points = []
...
def main():
    ...
    earth = Planet(-1 * Planet.AU, 0 , 16, (100, 149, 237) ,  5.9736*10**24)
    ...
    jupyter = Planet(-5.2 * Planet.AU, 0, 20, (106, 60, 31), 1.8986*10**27)
    jupyter.y_vel = -13.07 * 1000
    
    saturn = Planet(9.54 * Planet.AU, 0, 12, (218, 79, 0), 58.232*10**6)
    saturn.y_vel = -9.690 * 1000
    
    uranus = Planet(19.19 * Planet.AU,0, 16, (62, 142, 182),  25.362*10**6)
    uranus.y_vel = 6.81 * 1000
    
    neptune = Planet(30.06 * Planet.AU, 0, 14, (62, 63, 190), 24.622*10**6)
